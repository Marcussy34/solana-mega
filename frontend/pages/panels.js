  ...
  const initGSAP = () => {
    ...
    coloredPanels.forEach((panel, i) => {
      ...
      gsap.set(panel, {
        ...
        right: `${i * 5 - 5}%`,  // Adjusted to move panels more to the right
        top: `${i * 3 + 10}%`, // Added 10% to move all panels downward
        xPercent: 100,
        opacity: 0,
        scale: 0.85,
    ...
    <>
      ...
      <style jsx>{`
        ...
        #colored-panels-container {
          ...
          height: 100%;
          width: 100%;
          padding-top: 5%; /* Add padding at the top to move content down */
        }
